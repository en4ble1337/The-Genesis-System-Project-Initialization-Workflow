...
Goal: Transform a vague idea into a "Hallucination-Proof" codebase. Method: A 3-Stage Pipeline (Product -> Architecture -> Scaffold). How to use: Open a fresh AI chat (Claude/ChatGPT) and run these 3 prompts in order.
